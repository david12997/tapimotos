...
async function Get_all_products(page_cascos,page_aceites,page_llantas){
    ...
    try {
        ...
        //const cascos = await Get('https://tapimotosdk.com/blog/wp-json/public-woo/v1/products?category=356&per_page=3'+page_cascos);
        //(cascos === undefined) ? response.push('Error can not get data') : response.push(ParseData(cascos));

        //const aceites = await Get('https://tapimotosdk.com/blog/wp-json/public-woo/v1/products?category=358&per_page=3'+page_aceites);
